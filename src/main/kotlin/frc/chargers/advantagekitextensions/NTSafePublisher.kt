...
/**
 * Credits: [team 4099 Charged Up repository](https://github.com/team4099/ChargedUp-2023)
 *
 */
public class NTSafePublisher : LogDataReceiver {
        ...
        if (!DriverStation.isFMSAttached()) {
            ...
            for (field: Map.Entry<String, LogValue> in newMap) {
                ...
                when (newValue.type) {
                    ...
                    null -> println("ERROR: the type of a newValue is null. Something has gone wrong with NTSafePublisher")
                }
            }
